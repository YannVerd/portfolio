  ...
  return (
    <>
      ...
      <main className="md:w-[95%] w-full flex flex-col justify-between items-center mt-24 mb-20">
        <section className="flex w-full md:w-[80%] flex-wrap justify-between items-center mb-12">
          ...
          <Image src={'/photo_cv.jpg'} width={400} height={400} alt="profile image" className="rounded-full"/>
        </section>
        <section className="flex flex-col w-full md:w-[80%] h-auto justify-around items-center mb-12">
        ...
        <section className="flex flex-col w-full md:w-[80%] h-auto justify-around items-center mb-8">
