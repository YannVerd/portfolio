...
export default function CVModal(props: IModal){
    return (
        <div className="bg-white w-fit h-fit fixed rounded-lg border-secondary border-2 dark:bg-black shadow-lg left-[35%] top-[8%] flex-col justify-around items-center gap-4  z-50" style={{ display: props.isVisible ? 'flex' : 'none'}}>
